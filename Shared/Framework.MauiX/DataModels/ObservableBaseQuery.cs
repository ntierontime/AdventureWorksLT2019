...
public class ObservableBaseQuery: ObservableObject
{
    ...
    private TextSearchTypes m_TextSearchType;
    public TextSearchTypes TextSearchType
    {
    ...
    private PaginationOptions m_PaginationOption;
    public PaginationOptions PaginationOption
    {
