namespace Framework.Models
{
    ...
    public static class PreDefinedDateTimeRangesHelper
    {
        ...
        {
            if(Enum.TryParse<PreDefinedDateTimeRanges>(preDefinedDateTimeRange, out var preDefinedDateTimeRangeEnum))
            {
                return GetLowerBound(preDefinedDateTimeRangeEnum);
            }
            return GetLowerBound(PreDefinedDateTimeRanges.AllTime);
        }
        public static DateTime? GetLowerBound(PreDefinedDateTimeRanges preDefinedDateTimeRange)
        {
            if (preDefinedDateTimeRange == PreDefinedDateTimeRanges.AllTime)
            {
                return null;
            }
            else if (preDefinedDateTimeRange == PreDefinedDateTimeRanges.Custom)
            {
                return DateTime.Now;
            }
        ...
        public static DateTime? GetUpperBound(PreDefinedDateTimeRanges preDefinedDateTimeRange)
        {
            if (preDefinedDateTimeRange == PreDefinedDateTimeRanges.AllTime)
            {
                return null;
