        ...
        : IProductRepository
    {
            ...
            ProductAdvancedQuery query)
        {
            try
            {
                ...
                return new PagedResponse<ProductDataModel.DefaultView[]>
                {
            ...
            {
                return await Task<PagedResponse<ProductDataModel.DefaultView[]>>.FromResult(new PagedResponse<ProductDataModel.DefaultView[]>
                {
            ...
            MultiItemsCUDModel<ProductIdentifier, ProductDataModel.DefaultView> input)
        {
            ...
            if (input.DeleteItems != null)
            {
                ...
                {
                    return new Response<MultiItemsCUDModel<ProductIdentifier, ProductDataModel.DefaultView>> { Status = responseOfDeleteItems.Status, StatusMessage = "Deletion Failed. " + responseOfDeleteItems.StatusMessage };
                }
            }
            ...
            {
                return new Response<MultiItemsCUDModel<ProductIdentifier, ProductDataModel.DefaultView>> { Status = HttpStatusCode.OK };
            }
            ...
            try
            {
                ...
                // 3.3. Final Response
                var response = new Response<MultiItemsCUDModel<ProductIdentifier, ProductDataModel.DefaultView>>
                {
                    Status = HttpStatusCode.OK,
                    ResponseBody = new MultiItemsCUDModel<ProductIdentifier, ProductDataModel.DefaultView>
                    {
                        NewItems =
            ...
            {
                return await Task.FromResult(new Response<MultiItemsCUDModel<ProductIdentifier, ProductDataModel.DefaultView>>
                {
                    Status = HttpStatusCode.InternalServerError,
