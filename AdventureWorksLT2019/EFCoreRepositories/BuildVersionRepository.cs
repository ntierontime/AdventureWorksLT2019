...
namespace AdventureWorksLT2019.EFCoreRepositories
{
        ...
        : IBuildVersionRepository
    {
        ...
        public async Task<PagedResponse<BuildVersionDataModel[]>> Search(
            BuildVersionAdvancedQuery query)
        {
            try
            {
                ...
                return new PagedResponse<BuildVersionDataModel[]>
                {
            ...
            {
                return await Task<PagedResponse<BuildVersionDataModel[]>>.FromResult(new PagedResponse<BuildVersionDataModel[]>
                {
        ...
        public async Task<Response<MultiItemsCUDModel<BuildVersionIdentifier, BuildVersionDataModel>>> MultiItemsCUD(
            MultiItemsCUDModel<BuildVersionIdentifier, BuildVersionDataModel> input)
        {
            ...
            if (input.DeleteItems != null)
            {
                ...
                {
                    return new Response<MultiItemsCUDModel<BuildVersionIdentifier, BuildVersionDataModel>> { Status = responseOfDeleteItems.Status, StatusMessage = "Deletion Failed. " + responseOfDeleteItems.StatusMessage };
                }
            }
            ...
            {
                return new Response<MultiItemsCUDModel<BuildVersionIdentifier, BuildVersionDataModel>> { Status = HttpStatusCode.OK };
            }
            ...
            try
            {
                ...
                // 3.3. Final Response
                var response = new Response<MultiItemsCUDModel<BuildVersionIdentifier, BuildVersionDataModel>>
                {
                    Status = HttpStatusCode.OK,
                    ResponseBody = new MultiItemsCUDModel<BuildVersionIdentifier, BuildVersionDataModel>
                    {
                        NewItems =
            ...
            {
                return await Task.FromResult(new Response<MultiItemsCUDModel<BuildVersionIdentifier, BuildVersionDataModel>>
                {
                    Status = HttpStatusCode.InternalServerError,
