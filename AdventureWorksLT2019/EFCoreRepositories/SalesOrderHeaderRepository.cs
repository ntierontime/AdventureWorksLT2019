...
namespace AdventureWorksLT2019.EFCoreRepositories
{
        ...
        : ISalesOrderHeaderRepository
    {
        ...
        public async Task<PagedResponse<SalesOrderHeaderDataModel.DefaultView[]>> Search(
            SalesOrderHeaderAdvancedQuery query)
        {
            try
            {
                ...
                return new PagedResponse<SalesOrderHeaderDataModel.DefaultView[]>
                {
            ...
            {
                return await Task<PagedResponse<SalesOrderHeaderDataModel.DefaultView[]>>.FromResult(new PagedResponse<SalesOrderHeaderDataModel.DefaultView[]>
                {
        ...
        public async Task<PagedResponse<SalesOrderHeaderDataModel.DefaultView[]>> BulkUpdate(
            BatchActionViewModel<SalesOrderHeaderIdentifier, SalesOrderHeaderDataModel.DefaultView> data)
        {
            if (data.ActionData == null)
            {
                return await Task<PagedResponse<SalesOrderHeaderDataModel.DefaultView[]>>.FromResult(
                    new PagedResponse<SalesOrderHeaderDataModel.DefaultView[]> { Status = HttpStatusCode.BadRequest });
            }
            try
            {
            ...
            {
                return await Task<PagedResponse<SalesOrderHeaderDataModel.DefaultView[]>>.FromResult(
                    new PagedResponse<SalesOrderHeaderDataModel.DefaultView[]> { Status = HttpStatusCode.InternalServerError, StatusMessage = ex.Message });
            }
        }
...
private IQueryable<SalesOrderHeaderDataModel.DefaultView> GetIQueryableAsBulkUpdateResponse(
            ...
            MultiItemsCUDModel<SalesOrderHeaderIdentifier, SalesOrderHeaderDataModel.DefaultView> input)
        {
            ...
            if (input.DeleteItems != null)
            {
                ...
                {
                    return new Response<MultiItemsCUDModel<SalesOrderHeaderIdentifier, SalesOrderHeaderDataModel.DefaultView>> { Status = responseOfDeleteItems.Status, StatusMessage = "Deletion Failed. " + responseOfDeleteItems.StatusMessage };
                }
            }
            ...
            {
                return new Response<MultiItemsCUDModel<SalesOrderHeaderIdentifier, SalesOrderHeaderDataModel.DefaultView>> { Status = HttpStatusCode.OK };
            }
            ...
            try
            {
                ...
                // 3.3. Final Response
                var response = new Response<MultiItemsCUDModel<SalesOrderHeaderIdentifier, SalesOrderHeaderDataModel.DefaultView>>
                {
                    Status = HttpStatusCode.OK,
                    ResponseBody = new MultiItemsCUDModel<SalesOrderHeaderIdentifier, SalesOrderHeaderDataModel.DefaultView>
                    {
                        NewItems =
            ...
            {
                return await Task.FromResult(new Response<MultiItemsCUDModel<SalesOrderHeaderIdentifier, SalesOrderHeaderDataModel.DefaultView>>
                {
                    Status = HttpStatusCode.InternalServerError,
