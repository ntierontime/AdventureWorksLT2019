        ...
        : IAddressRepository
    {
            ...
            MultiItemsCUDRequest<AddressIdentifier, AddressDataModel> input)
        {
            ...
            if (input.DeleteItems != null)
            {
                ...
                {
                    return new Response<MultiItemsCUDRequest<AddressIdentifier, AddressDataModel>> { Status = responseOfDeleteItems.Status, StatusMessage = "Deletion Failed. " + responseOfDeleteItems.StatusMessage };
                }
            }
            ...
            {
                return new Response<MultiItemsCUDRequest<AddressIdentifier, AddressDataModel>> { Status = HttpStatusCode.OK };
            }
            ...
            try
            {
                ...
                // 3.3. Final Response
                var response = new Response<MultiItemsCUDRequest<AddressIdentifier, AddressDataModel>>
                {
                    Status = HttpStatusCode.OK,
                    ResponseBody = new MultiItemsCUDRequest<AddressIdentifier, AddressDataModel>
                    {
                        NewItems =
            ...
            {
                return await Task.FromResult(new Response<MultiItemsCUDRequest<AddressIdentifier, AddressDataModel>>
                {
                    Status = HttpStatusCode.InternalServerError,
