...
namespace AdventureWorksLT2019.EFCoreRepositories
{
        ...
        : IProductModelProductDescriptionRepository
    {
        ...
        public async Task<PagedResponse<ProductModelProductDescriptionDataModel.DefaultView[]>> Search(
            ProductModelProductDescriptionAdvancedQuery query)
        {
            try
            {
                ...
                return new PagedResponse<ProductModelProductDescriptionDataModel.DefaultView[]>
                {
            ...
            {
                return await Task<PagedResponse<ProductModelProductDescriptionDataModel.DefaultView[]>>.FromResult(new PagedResponse<ProductModelProductDescriptionDataModel.DefaultView[]>
                {
        ...
        public async Task<Response<MultiItemsCUDModel<ProductModelProductDescriptionIdentifier, ProductModelProductDescriptionDataModel.DefaultView>>> MultiItemsCUD(
            MultiItemsCUDModel<ProductModelProductDescriptionIdentifier, ProductModelProductDescriptionDataModel.DefaultView> input)
        {
            ...
            if (input.DeleteItems != null)
            {
                ...
                {
                    return new Response<MultiItemsCUDModel<ProductModelProductDescriptionIdentifier, ProductModelProductDescriptionDataModel.DefaultView>> { Status = responseOfDeleteItems.Status, StatusMessage = "Deletion Failed. " + responseOfDeleteItems.StatusMessage };
                }
            }
            ...
            {
                return new Response<MultiItemsCUDModel<ProductModelProductDescriptionIdentifier, ProductModelProductDescriptionDataModel.DefaultView>> { Status = HttpStatusCode.OK };
            }
            ...
            try
            {
                ...
                // 3.3. Final Response
                var response = new Response<MultiItemsCUDModel<ProductModelProductDescriptionIdentifier, ProductModelProductDescriptionDataModel.DefaultView>>
                {
                    Status = HttpStatusCode.OK,
                    ResponseBody = new MultiItemsCUDModel<ProductModelProductDescriptionIdentifier, ProductModelProductDescriptionDataModel.DefaultView>
                    {
                        NewItems =
            ...
            {
                return await Task.FromResult(new Response<MultiItemsCUDModel<ProductModelProductDescriptionIdentifier, ProductModelProductDescriptionDataModel.DefaultView>>
                {
                    Status = HttpStatusCode.InternalServerError,
