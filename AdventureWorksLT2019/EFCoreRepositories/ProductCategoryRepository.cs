        ...
        : IProductCategoryRepository
    {
            ...
            ProductCategoryAdvancedQuery query)
        {
            try
            {
                ...
                return new PagedResponse<ProductCategoryDataModel.DefaultView[]>
                {
            ...
            {
                return await Task<PagedResponse<ProductCategoryDataModel.DefaultView[]>>.FromResult(new PagedResponse<ProductCategoryDataModel.DefaultView[]>
                {
            ...
            MultiItemsCUDModel<ProductCategoryIdentifier, ProductCategoryDataModel.DefaultView> input)
        {
            ...
            if (input.DeleteItems != null)
            {
                ...
                {
                    return new Response<MultiItemsCUDModel<ProductCategoryIdentifier, ProductCategoryDataModel.DefaultView>> { Status = responseOfDeleteItems.Status, StatusMessage = "Deletion Failed. " + responseOfDeleteItems.StatusMessage };
                }
            }
            ...
            {
                return new Response<MultiItemsCUDModel<ProductCategoryIdentifier, ProductCategoryDataModel.DefaultView>> { Status = HttpStatusCode.OK };
            }
            ...
            try
            {
                ...
                // 3.3. Final Response
                var response = new Response<MultiItemsCUDModel<ProductCategoryIdentifier, ProductCategoryDataModel.DefaultView>>
                {
                    Status = HttpStatusCode.OK,
                    ResponseBody = new MultiItemsCUDModel<ProductCategoryIdentifier, ProductCategoryDataModel.DefaultView>
                    {
                        NewItems =
            ...
            {
                return await Task.FromResult(new Response<MultiItemsCUDModel<ProductCategoryIdentifier, ProductCategoryDataModel.DefaultView>>
                {
                    Status = HttpStatusCode.InternalServerError,
