...
namespace AdventureWorksLT2019.EFCoreRepositories
{
        ...
        : ICustomerAddressRepository
    {
        ...
        public async Task<Response<MultiItemsCUDModel<CustomerAddressIdentifier, CustomerAddressDataModel.DefaultView>>> MultiItemsCUD(
            MultiItemsCUDModel<CustomerAddressIdentifier, CustomerAddressDataModel.DefaultView> input)
        {
            ...
            if (input.DeleteItems != null)
            {
                ...
                {
                    return new Response<MultiItemsCUDModel<CustomerAddressIdentifier, CustomerAddressDataModel.DefaultView>> { Status = responseOfDeleteItems.Status, StatusMessage = "Deletion Failed. " + responseOfDeleteItems.StatusMessage };
                }
            }
            ...
            {
                return new Response<MultiItemsCUDModel<CustomerAddressIdentifier, CustomerAddressDataModel.DefaultView>> { Status = HttpStatusCode.OK };
            }
            ...
            try
            {
                ...
                List<CustomerAddress> newEFItems = new List<CustomerAddress>();
                if (input.NewItems != null && input.NewItems.Count > 0)
                {
                ...
                // 3.3. Final Response
                var response = new Response<MultiItemsCUDModel<CustomerAddressIdentifier, CustomerAddressDataModel.DefaultView>>
                {
                    Status = HttpStatusCode.OK,
                    ResponseBody = new MultiItemsCUDModel<CustomerAddressIdentifier, CustomerAddressDataModel.DefaultView>
                    {
                        NewItems =
            ...
            {
                return await Task.FromResult(new Response<MultiItemsCUDModel<CustomerAddressIdentifier, CustomerAddressDataModel.DefaultView>>
                {
                    Status = HttpStatusCode.InternalServerError,
