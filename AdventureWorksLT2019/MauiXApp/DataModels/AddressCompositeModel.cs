...
{
        // 4. ListTable = 4,
        public CustomerAddressDataModel[] CustomerAddresses_Via_AddressID { get; set; }
        public SalesOrderHeaderDataModel[] SalesOrderHeaders_Via_BillToAddressID { get; set; }
        public SalesOrderHeaderDataModel[] SalesOrderHeaders_Via_ShipToAddressID { get; set; }
