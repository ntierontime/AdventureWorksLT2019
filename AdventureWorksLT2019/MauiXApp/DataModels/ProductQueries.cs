...
public class ProductIdentifier: ObservableObject
{
    ...
    {
        if (obj == null || !(obj is ProductIdentifier))
            return false;
        var typedObj = (ProductIdentifier)obj;
        return ProductID == typedObj.ProductID;
    }
}
