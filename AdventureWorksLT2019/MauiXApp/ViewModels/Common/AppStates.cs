...
namespace AdventureWorksLT2019.MauiXApp.ViewModels.Common
{
    public class AppStates : ObservableObject
    {
        ...
        {
            WeakReferenceMessenger.Default.Register<AppStates, Messages.Common.GeoLocationChangedMessage>(this, (r, m) => r.CurrentLocation = m.Value);
            WeakReferenceMessenger.Default.Register<AppStates, Messages.Common.AuthenticatedMessage>(this, (r, m) => r.Authenticated = m.Value);
        }
    }
}
