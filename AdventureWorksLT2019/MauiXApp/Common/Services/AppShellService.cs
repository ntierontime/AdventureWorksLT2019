...
namespace AdventureWorksLT2019.MauiXApp.Common.Services
{
    public class AppShellService
    {
        ...
        public async Task AddFlyoutMenusDetails(bool gotoFirstTimeUserPage)
        {
            ...
            // SettingsPage
            AddFlyoutItem(
                nameof(AdventureWorksLT2019.MauiXApp.Views.Customer.ListPage),
                typeof(AdventureWorksLT2019.MauiXApp.Views.Customer.ListPage),
            ...
            gotoRoute = nameof(AdventureWorksLT2019.MauiXApp.Views.Customer.ListPage);
