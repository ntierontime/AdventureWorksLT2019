...
public class SalesOrderDetailService : IDataServiceBase<SalesOrderDetailAdvancedQuery, SalesOrderDetailIdentifier, SalesOrderDetailDataModel>
{

    private readonly SalesOrderDetailApiClient _thisApiClient;
    private readonly SalesOrderDetailRepository _thisRepository;
    ...
    public SalesOrderDetailService(
        ...
        SalesOrderDetailRepository thisRepository,
    ...
    public async Task CacheDeltaData()
    {
        ...
        var cachedDataStatusItem = await _cacheDataStatusService.Get(CachedData.SalesOrderDetail.ToString());
        ...
        await _cacheDataStatusService.SyncedServerData(CachedData.SalesOrderDetail.ToString());
    }

    public async Task<ListResponse<SalesOrderDetailDataModel[]>> Search(
        SalesOrderDetailAdvancedQuery query, ObservableQueryOrderBySetting queryOrderBySetting)
    {
        ...
        var response = new ListResponse<SalesOrderDetailDataModel[]>
        {
    ...
    public SalesOrderDetailDataModel GetDefault()
    {
