...
public class ProductDescriptionService : DataServiceBase<ProductDescriptionAdvancedQuery, ProductDescriptionIdentifier, ProductDescriptionDataModel>
{
    ...
    public override async Task<ListResponse<ProductDescriptionDataModel[]>> Search(
    ...
    public override async Task<Response> BulkDelete(List<ProductDescriptionIdentifier> ids)
    {
        var response = await _thisApiClient.BulkDelete(ids);
        return response;
    }

    public override async Task<Response<MultiItemsCUDRequest<ProductDescriptionIdentifier, ProductDescriptionDataModel>>> MultiItemsCUD(
    ...
    public override async Task<Response<ProductDescriptionDataModel>> Update(ProductDescriptionIdentifier id, ProductDescriptionDataModel input)
    {
        var response = await _thisApiClient.Update(id, input);
        return response;
    }

    public override async Task<Response<ProductDescriptionDataModel>> Get(ProductDescriptionIdentifier id)
    {
        var response = await _thisApiClient.Get(id);
        return response;
    }

    public override async Task<Response<ProductDescriptionDataModel>> Create(ProductDescriptionDataModel input)
    {
        var response = await _thisApiClient.Create(input);
        return response;
    }

    public override async Task<Response> Delete(ProductDescriptionIdentifier id)
    {
    ...
    public override ProductDescriptionDataModel GetDefault()
    {
