...
public class ProductModelService : DataServiceBase<ProductModelAdvancedQuery, ProductModelIdentifier, ProductModelDataModel>
{
    ...
    public override async Task<ListResponse<ProductModelDataModel[]>> Search(
    ...
    public override async Task<Response<ProductModelDataModel>> Get(ProductModelIdentifier id)
    {
        var response = await _thisApiClient.Get(id);
        return response;
    }

    public override async Task<Response<ProductModelDataModel>> Create(ProductModelDataModel input)
    {
        var response = await _thisApiClient.Create(input);
        return response;
    }

    public override async Task<Response> Delete(ProductModelIdentifier id)
    {
    ...
    public override ProductModelDataModel GetDefault()
    {
