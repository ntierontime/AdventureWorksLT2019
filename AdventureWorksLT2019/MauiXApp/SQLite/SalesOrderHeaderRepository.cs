...
public class SalesOrderHeaderRepository : SQLiteTableRepositoryBase<SalesOrderHeaderDataModel, SalesOrderHeaderAdvancedQuery, SalesOrderHeaderIdentifier>
{
    public SalesOrderHeaderRepository(SQLiteService sqLiteService) : base(sqLiteService)
    {
        _database.CreateTable<SalesOrderHeaderDataModel>();
    }

    protected override Expression<Func<SalesOrderHeaderDataModel, bool>> GetItemExpression(SalesOrderHeaderDataModel item)
    {
        return t => t.SalesOrderID == item.SalesOrderID;
    }

    protected override Expression<Func<SalesOrderHeaderDataModel, bool>> GetItemExpression(SalesOrderHeaderIdentifier identifier)
    {
        return t => t.SalesOrderID == identifier.SalesOrderID;
    }
    ...
    /// <returns></returns>
    protected override Expression<Func<SalesOrderHeaderDataModel, bool>> GetSQLiteTableQueryPredicateByAdvancedQuery(SalesOrderHeaderAdvancedQuery query)
    {
        return t => true;
