...
public class SalesOrderDetailRepository : SQLiteTableRepositoryBase<SalesOrderDetailDataModel, SalesOrderDetailAdvancedQuery, SalesOrderDetailIdentifier>
{
    public SalesOrderDetailRepository(SQLiteService sqLiteService) : base(sqLiteService)
    {
        _database.CreateTable<SalesOrderDetailDataModel>();
    }

    protected override Expression<Func<SalesOrderDetailDataModel, bool>> GetItemExpression(SalesOrderDetailDataModel item)
    {
        return t => t.SalesOrderID == item.SalesOrderID&&t.SalesOrderDetailID == item.SalesOrderDetailID;
    }

    protected override Expression<Func<SalesOrderDetailDataModel, bool>> GetItemExpression(SalesOrderDetailIdentifier identifier)
    {
        return t => t.SalesOrderID == identifier.SalesOrderID&&t.SalesOrderDetailID == identifier.SalesOrderDetailID;
    }
