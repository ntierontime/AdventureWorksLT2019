...
public class ProductDescriptionRepository : SQLiteTableRepositoryBase<ProductDescriptionDataModel, ProductDescriptionAdvancedQuery, ProductDescriptionIdentifier>
{
    public ProductDescriptionRepository(SQLiteService sqLiteService) : base(sqLiteService)
    {
        _database.CreateTable<ProductDescriptionDataModel>();
    }

    protected override Expression<Func<ProductDescriptionDataModel, bool>> GetItemExpression(ProductDescriptionDataModel item)
    {
        return t => t.ProductDescriptionID == item.ProductDescriptionID;
    }

    protected override Expression<Func<ProductDescriptionDataModel, bool>> GetItemExpression(ProductDescriptionIdentifier identifier)
    {
        return t => t.ProductDescriptionID == identifier.ProductDescriptionID;
    }
    ...
    /// <returns></returns>
    protected override Expression<Func<ProductDescriptionDataModel, bool>> GetSQLiteTableQueryPredicateByAdvancedQuery(ProductDescriptionAdvancedQuery query)
    {
        return t => true;
