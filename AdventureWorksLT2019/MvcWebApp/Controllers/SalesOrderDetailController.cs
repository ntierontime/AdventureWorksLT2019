...
namespace AdventureWorksLT2019.MvcWebApp.Controllers
{
    public class SalesOrderDetailController : Controller
    {
            ...
            SalesOrderDetailIdentifier id)
        {
            ...
            var itemViewModel = new AdventureWorksLT2019.MvcWebApp.Models.MvcItemViewModel<SalesOrderDetailDataModel.DefaultView>
            {
                        ...
                        return PartialView("~/Views/Shared/_AjaxResponse.cshtml",
                            new AjaxResponseViewModel
                            {
                                ...
                                new Tuple<string, object>("~/Views/SalesOrderDetail/_TableItemTr.cshtml",
                                    new AdventureWorksLT2019.MvcWebApp.Models.MvcItemViewModel<SalesOrderDetailDataModel.DefaultView>{
                                        UIItemFeatures = _viewFeatureManager.GetSalesOrderDetailUIItemFeatures(),
                                        Status = System.Net.HttpStatusCode.OK,
        ...
        public async Task<IActionResult> AjaxBulkDelete(
            [FromForm] BatchActionViewModel<SalesOrderDetailIdentifier> data)
        {
            ...
            [FromForm] List<SalesOrderDetailDataModel.DefaultView> data)
        {
            ...
            var multiItemsCUDModel = new MultiItemsCUDModel<SalesOrderDetailIdentifier, SalesOrderDetailDataModel.DefaultView>
            {
                DeleteItems =
                    (from t in data
        ...
        public async Task<IActionResult> Edit([FromRoute]SalesOrderDetailIdentifier id)
        {
            if (!id.SalesOrderID.HasValue && !id.SalesOrderDetailID.HasValue)
            {
                var itemViewModel1 = new AdventureWorksLT2019.MvcWebApp.Models.MvcItemViewModel<SalesOrderDetailDataModel.DefaultView>
                {
        ...
        public async Task<IActionResult> Create()
        {
            ...
            var itemViewModel = await Task.FromResult(new AdventureWorksLT2019.MvcWebApp.Models.MvcItemViewModel<SalesOrderDetailDataModel.DefaultView>
            {
                Status = System.Net.HttpStatusCode.OK,
