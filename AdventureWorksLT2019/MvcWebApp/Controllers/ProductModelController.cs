...
namespace AdventureWorksLT2019.MvcWebApp.Controllers
{
    public class ProductModelController : Controller
    {
        ...
        public async Task<IActionResult> Index(ProductModelAdvancedQuery query, UIParams uiParams)
        {
            ...
            {
                query.OrderBys = _orderBysListHelper.GetDefaultProductModelOrderBys();
            }

            var result = await _thisService.Search(query);

            var vm = await _pagedSearchViewModelHelper.GetProductModelPagedSearchViewModel("index", uiParams, query, result, true, true);
            return View(vm);
        }

        // GET: ProductModel/AjaxLoadItems
        [HttpGet] // from query string
        [HttpPost]// form post formdata
        public async Task<IActionResult> AjaxLoadItems(ProductModelAdvancedQuery query, UIParams uiParams)
        {
            var result = await _thisService.Search(query);
            var pagedViewModel = new PagedViewModel<ProductModelDataModel[]>
            {
                UIListSetting = _viewFeatureManager.GetProductModelUIListSetting(String.Empty, uiParams),
                Result = result,
            };
            ...
            {
                return PartialView("~/Views/ProductModel/_Table.cshtml", pagedViewModel);
            }
            else if (uiParams.PagedViewOption == PagedViewOptions.Tiles)
            {
                return PartialView("~/Views/ProductModel/_Tiles.cshtml", pagedViewModel);
            }
            //else // if (uiParams.PagedViewOption == PagedViewOptions.SlideShow)
            // SlideShow
            return PartialView("~/Views/ProductModel/_SlideShow.cshtml", pagedViewModel);
            ...
            ProductModelIdentifier id)
        {
            ...
            var itemViewModel = new AdventureWorksLT2019.MvcWebApp.Models.MvcItemViewModel<ProductModelDataModel>
            {
                UIItemFeatures = _viewFeatureManager.GetProductModelUIItemFeatures(),
                    ...
                    if (view == PagedViewOptions.Table) // Html Table
                    {
                        return PartialView("~/Views/Shared/_AjaxResponse.cshtml",
                            new AjaxResponseViewModel
                            {
                                ...
                                new Tuple<string, object>("~/Views/ProductModel/_TableItemTr.cshtml",
                                    new AdventureWorksLT2019.MvcWebApp.Models.MvcItemViewModel<ProductModelDataModel>{
                                        UIItemFeatures = _viewFeatureManager.GetProductModelUIItemFeatures(),
                                        Status = System.Net.HttpStatusCode.OK,
                    ...
                    //else // Tiles
                    {
                        return PartialView("~/Views/Shared/_AjaxResponse.cshtml",
                            new AjaxResponseViewModel
                            {
                                ...
                                PartialViews = new List<Tuple<string, object>>
                                {
                                    new Tuple<string, object>("~/Views/ProductModel/_Tile.cshtml",
                                        new AdventureWorksLT2019.MvcWebApp.Models.MvcItemViewModel<ProductModelDataModel>
                                        {
                                            UIItemFeatures = _viewFeatureManager.GetProductModelUIItemFeatures(),
                                            Status = System.Net.HttpStatusCode.OK,
        ...
        // POST: ProductModel/AjaxEdit/{ProductModelID}
                ...
                if (result.Status == System.Net.HttpStatusCode.OK)
                {
                    if (view == PagedViewOptions.Table) // Html Table
                    {
                        return PartialView("~/Views/Shared/_AjaxResponse.cshtml", new AjaxResponseViewModel
                        {
                            ...
                            PartialViews = new List<Tuple<string, object>>
                            {
                                new Tuple<string, object>("~/Views/ProductModel/_TableDetailsItem.cshtml",
                                    new AdventureWorksLT2019.MvcWebApp.Models.MvcItemViewModel<ProductModelDataModel>
                                    {
                                        UIItemFeatures = _viewFeatureManager.GetProductModelUIItemFeatures(),
                                        Status = System.Net.HttpStatusCode.OK,
                    ...
                    else // Tiles
                    {
                        return PartialView("~/Views/Shared/_AjaxResponse.cshtml", new AjaxResponseViewModel
                        {
                            ...
                            PartialViews = new List<Tuple<string, object>>
                            {
                                new Tuple<string, object>("~/Views/ProductModel/_TileDetailsItem.cshtml",
                                    new AdventureWorksLT2019.MvcWebApp.Models.MvcItemViewModel<ProductModelDataModel>
                                    {
                                        UIItemFeatures = _viewFeatureManager.GetProductModelUIItemFeatures(),
                                        Status = System.Net.HttpStatusCode.OK,
        ...
        public async Task<IActionResult> AjaxBulkDelete(
            [FromForm] BatchActionViewModel<ProductModelIdentifier> data)
        {
            ...
            [FromForm] List<ProductModelDataModel> data)
        {
            ...
            var multiItemsCUDModel = new MultiItemsCUDModel<ProductModelIdentifier, ProductModelDataModel>
            {
                DeleteItems =
                    (from t in data
        ...
        public async Task<IActionResult> Edit([FromRoute]ProductModelIdentifier id)
        {
            if (!id.ProductModelID.HasValue)
            {
                var itemViewModel1 = new AdventureWorksLT2019.MvcWebApp.Models.MvcItemViewModel<ProductModelDataModel>
                {
        ...
        {
            var itemViewModel = await Task.FromResult(new AdventureWorksLT2019.MvcWebApp.Models.MvcItemViewModel<ProductModelDataModel>
            {
                Status = System.Net.HttpStatusCode.OK,
