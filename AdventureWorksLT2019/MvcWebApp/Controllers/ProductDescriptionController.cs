...
namespace AdventureWorksLT2019.MvcWebApp.Controllers
{
    public class ProductDescriptionController : Controller
    {
        ...
        {
            var result = await _thisService.Search(query);
            var pagedViewModel = new PagedViewModel<ProductDescriptionDataModel[]>
            {
            ...
            ProductDescriptionIdentifier id)
        {
            ...
            var itemViewModel = new AdventureWorksLT2019.MvcWebApp.Models.MvcItemViewModel<ProductDescriptionDataModel>
            {
                UIItemFeatures = _viewFeatureManager.GetProductDescriptionUIItemFeatures(),
                        ...
                        return PartialView("~/Views/Shared/_AjaxResponse.cshtml",
                            new AjaxResponseViewModel
                            {
                                ...
                                new Tuple<string, object>("~/Views/ProductDescription/_TableItemTr.cshtml",
                                    new AdventureWorksLT2019.MvcWebApp.Models.MvcItemViewModel<ProductDescriptionDataModel>{
                                        UIItemFeatures = _viewFeatureManager.GetProductDescriptionUIItemFeatures(),
                                        Status = System.Net.HttpStatusCode.OK,
        ...
        public async Task<IActionResult> AjaxBulkDelete(
            [FromForm] BatchActionViewModel<ProductDescriptionIdentifier> data)
        {
            ...
            [FromForm] List<ProductDescriptionDataModel> data)
        {
            ...
            var multiItemsCUDModel = new MultiItemsCUDModel<ProductDescriptionIdentifier, ProductDescriptionDataModel>
            {
                DeleteItems =
                    (from t in data
        ...
        public async Task<IActionResult> Edit([FromRoute]ProductDescriptionIdentifier id)
        {
            if (!id.ProductDescriptionID.HasValue)
            {
                var itemViewModel1 = new AdventureWorksLT2019.MvcWebApp.Models.MvcItemViewModel<ProductDescriptionDataModel>
                {
        ...
        {
            var itemViewModel = await Task.FromResult(new AdventureWorksLT2019.MvcWebApp.Models.MvcItemViewModel<ProductDescriptionDataModel>
            {
                Status = System.Net.HttpStatusCode.OK,
