...
namespace AdventureWorksLT2019.MvcWebApp.Controllers
{
    public class CustomerAddressController : Controller
    {
            ...
            CustomerAddressIdentifier id)
        {
            ...
            var itemViewModel = new Framework.Mvc.Models.MvcItemViewModel<CustomerAddressDataModel.DefaultView>
            {
                UIItemFeatures = _viewFeatureManager.GetCustomerAddressUIItemFeatures(view),
                        ...
                        return PartialView("~/Views/Shared/_AjaxResponse.cshtml",
                            new AjaxResponseViewModel
                            {
                                ...
                                new Tuple<string, object>("~/Views/CustomerAddress/_TableItemTr.cshtml",
                                    new Framework.Mvc.Models.MvcItemViewModel<CustomerAddressDataModel.DefaultView>{
                                        UIItemFeatures = _viewFeatureManager.GetCustomerAddressUIItemFeatures(view),
                                        Status = System.Net.HttpStatusCode.OK,
        ...
        public async Task<IActionResult> AjaxBulkDelete(
            [FromForm] BatchActionRequest<CustomerAddressIdentifier> data)
        {
            ...
            [FromForm] List<CustomerAddressDataModel.DefaultView> data)
        {
            ...
            var multiItemsCUDModel = new MultiItemsCUDRequest<CustomerAddressIdentifier, CustomerAddressDataModel.DefaultView>
            {
                DeleteItems =
                    (from t in data
        ...
        public async Task<IActionResult> Edit([FromRoute]CustomerAddressIdentifier id)
        {
            if (!id.CustomerID.HasValue && !id.AddressID.HasValue)
            {
                var itemViewModel1 = new Framework.Mvc.Models.MvcItemViewModel<CustomerAddressDataModel.DefaultView>
                {
        ...
        public async Task<IActionResult> Create()
        {
            ...
            var itemViewModel = await Task.FromResult(new Framework.Mvc.Models.MvcItemViewModel<CustomerAddressDataModel.DefaultView>
            {
                Status = System.Net.HttpStatusCode.OK,
