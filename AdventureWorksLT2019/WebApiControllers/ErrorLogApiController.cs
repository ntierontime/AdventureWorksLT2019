...
namespace AdventureWorksLT2019.WebApiControllers
{
    ...
    public partial class ErrorLogApiController : BaseApiController
    {
        ...
        // [Authorize]
        [HttpPut]
        public async Task<ActionResult> BulkDelete([FromBody]List<ErrorLogIdentifier> ids)
        {
        ...
        [HttpPost]
        public async Task<ActionResult<Response<ErrorLogDataModel>>> CreateComposite(ErrorLogCompositeModel input)
        {
