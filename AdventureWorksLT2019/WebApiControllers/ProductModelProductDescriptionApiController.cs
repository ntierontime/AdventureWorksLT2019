...
namespace AdventureWorksLT2019.WebApiControllers
{
    ...
    public partial class ProductModelProductDescriptionApiController : BaseApiController
    {
        ...
        [HttpPost]
        public async Task<ActionResult<Response<ProductModelProductDescriptionDataModel.DefaultView>>> CreateComposite(ProductModelProductDescriptionCompositeModel input)
        {
