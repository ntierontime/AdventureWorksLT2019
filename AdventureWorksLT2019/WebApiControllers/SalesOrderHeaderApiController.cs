...
namespace AdventureWorksLT2019.WebApiControllers
{
    ...
    public partial class SalesOrderHeaderApiController : BaseApiController
    {
        ...
        // [Authorize]
        [HttpPut]
        public async Task<ActionResult> BulkDelete([FromBody]List<SalesOrderHeaderIdentifier> ids)
        {
        ...
        [HttpPost]
        public async Task<ActionResult<Response<SalesOrderHeaderDataModel.DefaultView>>> CreateComposite(SalesOrderHeaderCompositeModel input)
        {
