...
namespace AdventureWorksLT2019.WebApiControllers
{
    ...
    public partial class ProductCategoryApiController : BaseApiController
    {
        ...
        // [Authorize]
        [HttpPut]
        public async Task<ActionResult<Response<MultiItemsCUDModel<ProductCategoryIdentifier, ProductCategoryDataModel.DefaultView>>>> MultiItemsCUD(
        ...
        // [Authorize]
        [HttpPost]
        public async Task<ActionResult<ProductCategoryDataModel.DefaultView>> Post(ProductCategoryIdentifier id, ProductCategoryDataModel input)
        {
        ...
        // [Authorize]
        [HttpGet]
        public async Task<ActionResult<ProductCategoryDataModel.DefaultView>> Get(ProductCategoryIdentifier id)
        {
        ...
        // [Authorize]
        [HttpPut]
        public async Task<ActionResult<ProductCategoryDataModel.DefaultView>> Put(ProductCategoryDataModel input)
        {
        ...
        // [Authorize]
        [HttpDelete]
        public async Task<ActionResult> Delete(ProductCategoryIdentifier id)
        {
