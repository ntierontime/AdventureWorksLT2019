...
namespace AdventureWorksLT2019.WebApiControllers
{
    ...
    public partial class ProductModelApiController : BaseApiController
    {
        ...
        [HttpGet]
        [HttpPost]
        public async Task<ActionResult<PagedResponse<ProductModelDataModel[]>>> Search(
        ...
        // [Authorize]
        [HttpPut]
        public async Task<ActionResult<Response<MultiItemsCUDModel<ProductModelIdentifier, ProductModelDataModel>>>> MultiItemsCUD(
        ...
        // [Authorize]
        [HttpPost]
        public async Task<ActionResult<ProductModelDataModel>> Post(ProductModelIdentifier id, ProductModelDataModel input)
        {
        ...
        // [Authorize]
        [HttpGet]
        public async Task<ActionResult<ProductModelDataModel>> Get(ProductModelIdentifier id)
        {
        ...
        // [Authorize]
        [HttpPut]
        public async Task<ActionResult<ProductModelDataModel>> Put(ProductModelDataModel input)
        {
        ...
        // [Authorize]
        [HttpDelete]
        public async Task<ActionResult> Delete(ProductModelIdentifier id)
        {
