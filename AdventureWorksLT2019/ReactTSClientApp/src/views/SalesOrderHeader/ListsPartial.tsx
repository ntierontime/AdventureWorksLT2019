...
import { search, bulkDelete } from 'src/slices/SalesOrderHeaderSlice';
        ...
        <>
            ...
            <Dialog open={openItemDialog} fullWidth={true} maxWidth={'lg'}>
                <ItemViewsPartial {...crudItemPartialViewProps} 
                    ...
                    isItemSelected={!!currentItemOnDialog && isSelected(getISalesOrderHeaderIdentifier(currentItemOnDialog))} 
