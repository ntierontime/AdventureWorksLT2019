...
import { defaultSalesOrderDetail, ISalesOrderDetailDataModel } from 'src/dataModels/ISalesOrderDetailDataModel';
...
export default function ItemViewsPartial(props: ItemPartialViewProps<ISalesOrderDetailDataModel>): JSX.Element {
    ...
    return (
        <>
            {viewItemTemplate === ViewItemTemplates.Create &&
                <CreatePartial {...props}  item = {defaultSalesOrderDetail()}/>
            }
