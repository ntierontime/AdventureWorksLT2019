...
import { search, bulkDelete } from 'src/slices/ProductModelSlice';
import { getProductModelQueryOrderBySettings, IProductModelAdvancedQuery, IProductModelIdentifier, getIProductModelIdentifier, compareIProductModelIdentifier } from 'src/dataModels/IProductModelQueries';
...
export default function ListsPartial(props: ListsPartialViewProps<IProductModelAdvancedQuery, IProductModelDataModel>): JSX.Element {
    ...
    const [currentItemOnDialog, setCurrentItemOnDialog] = useState<IProductModelDataModel>();
    ...
    const renderEnhancedTopToolbar = () => {
        ...
        } as ListToolBarProps<IProductModelAdvancedQuery, IProductModelIdentifier>;
        ...
        <>
            ...
            <Dialog open={openItemDialog} fullWidth={true} maxWidth={'lg'}>
                <ItemViewsPartial {...crudItemPartialViewProps} 
                    ...
                    isItemSelected={!!currentItemOnDialog && isSelected(getIProductModelIdentifier(currentItemOnDialog))} 
