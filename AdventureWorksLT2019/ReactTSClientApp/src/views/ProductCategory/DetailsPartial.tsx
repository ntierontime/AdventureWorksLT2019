            ...
            <>
                ...
                <ButtonGroup
                    ...
                    {(crudViewContainer === CrudViewContainers.StandaloneView) &&
                        <>
                            <IconButton aria-label="delete" color="primary" onClick={() => { navigate("/productCategory/delete/" + getRouteParamsOfIProductCategoryIdentifier(item)) }}>
                                <DeleteIcon />
                            </IconButton>
                            <IconButton aria-label="edit" color="primary" onClick={() => { navigate("/productCategory/edit/" + getRouteParamsOfIProductCategoryIdentifier(item)) }}>
                                <EditIcon />
                            </IconButton>
                        </>
                    }
