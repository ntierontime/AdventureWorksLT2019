...
export interface ListPartialViewProps<TDataModel, TIdentifier> {
    ...
    // for EditableHtmlTablePartial
    onSubmit?: (param: { editableListItems: TDataModel[] }) => void;
    renderMainButtonGroup?: (disableNextButton: () => boolean, submitRef: React.MutableRefObject<any>) => JSX.Element;
}
