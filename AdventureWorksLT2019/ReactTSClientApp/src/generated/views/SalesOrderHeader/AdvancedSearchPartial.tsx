...
import { setISalesOrderHeaderAdvancedQuery } from 'src/generated/slices/SalesOrderHeaderSlice';
...
export default function AdvancedSearchPartial(props: AdvancedSearchPartialViewProps<ISalesOrderHeaderAdvancedQuery>): JSX.Element {
    ...
    return (
        <Card component="form" noValidate onSubmit={handleSubmit(onSubmit)}>
            <CardHeader
                title={t("SearchSalesOrderHeader")}
            />
            <CardContent>
            ...
            <CardActions disableSpacing
                ...
                <ButtonGroup>
                    <Button
                        ...
                        onClick={() => { dispatch(setISalesOrderHeaderAdvancedQuery(defaultISalesOrderHeaderAdvancedQuery())) }}
                    >
                        {t('ReSet')}
                    </Button>
                    <LoadingButton
