...
import { defaultSalesOrderHeader, ISalesOrderHeaderDataModel } from 'src/dataModels/ISalesOrderHeaderDataModel';
import { getISalesOrderHeaderIdentifier, getRouteParamsOfISalesOrderHeaderIdentifier } from 'src/dataModels/ISalesOrderHeaderQueries';

import { post, put } from 'src/generated/slices/SalesOrderHeaderSlice';
...
export default function ItemViewsPartial(props: ItemViewsPartialProps<ISalesOrderHeaderDataModel>): JSX.Element {
    ...
    const onSubmit_WhenCreate_DispatchAsyncThunk = (data: ISalesOrderHeaderDataModel, index: number) => {
        setSubmitting(true);
    ...
    const onSubmit_WhenEdit_DispatchAsyncThunk = (data: ISalesOrderHeaderDataModel, index: number) => {
        setSubmitting(true);
    ...
    return (
        <>
            ...
            {viewItemTemplate === ViewItemTemplates.Create &&
                <CreatePartial {...defaultItemCardProps} doneAction={doneAction} item={defaultSalesOrderHeader()}
