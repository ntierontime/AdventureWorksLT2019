...
import { search } from 'src/generated/slices/ProductModelSlice';
import { getProductModelQueryOrderBySettings, IProductModelAdvancedQuery, IProductModelIdentifier } from 'src/dataModels/IProductModelQueries';
            ...
            <Box sx={{ width: '100%' }}>
                <Paper sx={{ width: '100%', mb: 2 }}>
                    ...
                    {listViewOption === ListViewOptions.Table && <HtmlTablePartial
                        ...
                        isSelected={(identifier: IProductModelIdentifier) => { return false; }}
                    />}
                </Paper>
            </Box>
