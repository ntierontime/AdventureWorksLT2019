...
import { defaultProductModel, IProductModelDataModel } from 'src/dataModels/IProductModelDataModel';
import { getIProductModelIdentifier, getRouteParamsOfIProductModelIdentifier } from 'src/dataModels/IProductModelQueries';

import { post, put } from 'src/generated/slices/ProductModelSlice';
...
export default function ItemViewsPartial(props: ItemViewsPartialProps<IProductModelDataModel>): JSX.Element {
    ...
    const onSubmit_WhenCreate_DispatchAsyncThunk = (data: IProductModelDataModel, index: number) => {
        setSubmitting(true);
    ...
    const onSubmit_WhenEdit_DispatchAsyncThunk = (data: IProductModelDataModel, index: number) => {
        setSubmitting(true);
    ...
    return (
        <>
            ...
            {viewItemTemplate === ViewItemTemplates.Create &&
                <CreatePartial {...defaultItemCardProps} doneAction={doneAction} item={defaultProductModel()}
