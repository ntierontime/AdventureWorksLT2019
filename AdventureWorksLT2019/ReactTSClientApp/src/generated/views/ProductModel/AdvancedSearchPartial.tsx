...
import { setIProductModelAdvancedQuery } from 'src/generated/slices/ProductModelSlice';

export default function AdvancedSearchPartial(props: AdvancedSearchPartialViewProps<IProductModelAdvancedQuery>): JSX.Element {
    ...
    const { register, control, handleSubmit, reset, setValue } = useForm({
        ...
        defaultValues: defaultIProductModelAdvancedQuery(),
    },);


    const onSubmit = (query: IProductModelAdvancedQuery) => {
            ...
            <CardActions disableSpacing
                ...
                <ButtonGroup>
                    <Button
                        ...
                        onClick={() => { dispatch(setIProductModelAdvancedQuery(defaultIProductModelAdvancedQuery())) }}
                    >
                        {t('ReSet')}
                    </Button>
                    <LoadingButton
