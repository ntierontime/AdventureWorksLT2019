...
import { getProductModelAvatar, getProductModelTitle, IProductModelDataModel } from 'src/dataModels/IProductModelDataModel';
import { getRouteParamsOfIProductModelIdentifier } from 'src/dataModels/IProductModelQueries';

export default function DetailsPartial(props: ItemCardProps<IProductModelDataModel>): JSX.Element {
    ...
    const title = getProductModelTitle(item);
