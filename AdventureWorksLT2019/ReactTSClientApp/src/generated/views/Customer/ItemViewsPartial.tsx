...
import { defaultCustomer, ICustomerDataModel } from 'src/dataModels/ICustomerDataModel';
import { getICustomerIdentifier, getRouteParamsOfICustomerIdentifier } from 'src/dataModels/ICustomerQueries';

import { post, put } from 'src/generated/slices/CustomerSlice';
...
export default function ItemViewsPartial(props: ItemViewsPartialProps<ICustomerDataModel>): JSX.Element {
    ...
    const onSubmit_WhenCreate_DispatchAsyncThunk = (data: ICustomerDataModel, index: number) => {
        setSubmitting(true);
    ...
    const onSubmit_WhenEdit_DispatchAsyncThunk = (data: ICustomerDataModel, index: number) => {
        setSubmitting(true);
    ...
    return (
        <>
            ...
            {viewItemTemplate === ViewItemTemplates.Create &&
                <CreatePartial {...defaultItemCardProps} doneAction={doneAction} item={defaultCustomer()}
