...
import { setIProductCategoryAdvancedQuery } from 'src/generated/slices/ProductCategorySlice';
            ...
            <CardActions disableSpacing
                ...
                <ButtonGroup>
                    <Button
                        ...
                        onClick={() => { dispatch(setIProductCategoryAdvancedQuery(defaultIProductCategoryAdvancedQuery())) }}
                    >
                        {t('ReSet')}
                    </Button>
                    <LoadingButton
