...
import { defaultAddress, IAddressDataModel } from 'src/dataModels/IAddressDataModel';
import { getIAddressIdentifier, getRouteParamsOfIAddressIdentifier } from 'src/dataModels/IAddressQueries';

import { post, put } from 'src/generated/slices/AddressSlice';
...
export default function ItemViewsPartial(props: ItemViewsPartialProps<IAddressDataModel>): JSX.Element {
    ...
    const onSubmit_WhenCreate_DispatchAsyncThunk = (data: IAddressDataModel, index: number) => {
        setSubmitting(true);
    ...
    const onSubmit_WhenEdit_DispatchAsyncThunk = (data: IAddressDataModel, index: number) => {
        setSubmitting(true);
    ...
    return (
        <>
            ...
            {viewItemTemplate === ViewItemTemplates.Create &&
                <CreatePartial {...defaultItemCardProps} doneAction={doneAction} item={defaultAddress()}
