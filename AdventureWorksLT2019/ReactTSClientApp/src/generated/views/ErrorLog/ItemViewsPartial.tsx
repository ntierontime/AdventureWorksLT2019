...
import { defaultErrorLog, IErrorLogDataModel } from 'src/dataModels/IErrorLogDataModel';
import { getIErrorLogIdentifier, getRouteParamsOfIErrorLogIdentifier } from 'src/dataModels/IErrorLogQueries';

import { post, put } from 'src/generated/slices/ErrorLogSlice';
...
export default function ItemViewsPartial(props: ItemViewsPartialProps<IErrorLogDataModel>): JSX.Element {
    ...
    const onSubmit_WhenCreate_DispatchAsyncThunk = (data: IErrorLogDataModel, index: number) => {
        setSubmitting(true);
    ...
    const onSubmit_WhenEdit_DispatchAsyncThunk = (data: IErrorLogDataModel, index: number) => {
        setSubmitting(true);
    ...
    return (
        <>
            ...
            {viewItemTemplate === ViewItemTemplates.Create &&
                <CreatePartial {...defaultItemCardProps} doneAction={doneAction} item={defaultErrorLog()}
