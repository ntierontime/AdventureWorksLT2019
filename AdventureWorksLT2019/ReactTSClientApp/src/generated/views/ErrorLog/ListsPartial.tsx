...
import { search } from 'src/generated/slices/ErrorLogSlice';
import { getErrorLogQueryOrderBySettings, IErrorLogAdvancedQuery, IErrorLogIdentifier } from 'src/dataModels/IErrorLogQueries';
            ...
            <Box sx={{ width: '100%' }}>
                <Paper sx={{ width: '100%', mb: 2 }}>
                    ...
                    {listViewOption === ListViewOptions.Table && <HtmlTablePartial
                        ...
                        isSelected={(identifier: IErrorLogIdentifier) => { return false; }}
                    />}
                </Paper>
            </Box>
