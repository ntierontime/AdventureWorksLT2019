                            ...
                            .map((row, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell align='center'>{t(i18nFormats.dateTime.format, { val: new Date(row.errorTime), formatParams: { val: i18nFormats.dateTime.dateTimeShort, } })}</TableCell>
                                        <TableCell align='center'>{row.userName}</TableCell>
                                        <TableCell align='center'>{t(i18nFormats.number.format, { val: row.errorNumber })}</TableCell>
                                        <TableCell align='center'>{t(i18nFormats.number.format, { val: row.errorSeverity })}</TableCell>
                                        <TableCell align='center'>{t(i18nFormats.number.format, { val: row.errorState })}</TableCell>
                                        <TableCell align='center'>{row.errorProcedure}</TableCell>
                                        <TableCell align='center'>{t(i18nFormats.number.format, { val: row.errorLine })}</TableCell>
