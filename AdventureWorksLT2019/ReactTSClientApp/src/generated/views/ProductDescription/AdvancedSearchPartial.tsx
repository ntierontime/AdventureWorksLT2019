...
import { setIProductDescriptionAdvancedQuery } from 'src/generated/slices/ProductDescriptionSlice';

export default function AdvancedSearchPartial(props: AdvancedSearchPartialViewProps<IProductDescriptionAdvancedQuery>): JSX.Element {
    ...
    const { register, control, handleSubmit, reset, setValue } = useForm({
        ...
        defaultValues: defaultIProductDescriptionAdvancedQuery(),
    },);


    const onSubmit = (query: IProductDescriptionAdvancedQuery) => {
    ...
    return (
        <Card component="form" noValidate onSubmit={handleSubmit(onSubmit)}>
            <CardHeader
                title={t("SearchProductDescription")}
            />
            <CardContent>
            ...
            <CardActions disableSpacing
                ...
                <ButtonGroup>
                    <Button
                        ...
                        onClick={() => { dispatch(setIProductDescriptionAdvancedQuery(defaultIProductDescriptionAdvancedQuery())) }}
                    >
                        {t('ReSet')}
                    </Button>
                    <LoadingButton
