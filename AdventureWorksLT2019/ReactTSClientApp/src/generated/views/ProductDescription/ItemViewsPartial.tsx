...
import { defaultProductDescription, IProductDescriptionDataModel } from 'src/dataModels/IProductDescriptionDataModel';
import { getIProductDescriptionIdentifier, getRouteParamsOfIProductDescriptionIdentifier } from 'src/dataModels/IProductDescriptionQueries';

import { post, put } from 'src/generated/slices/ProductDescriptionSlice';
...
export default function ItemViewsPartial(props: ItemViewsPartialProps<IProductDescriptionDataModel>): JSX.Element {
    ...
    const onSubmit_WhenCreate_DispatchAsyncThunk = (data: IProductDescriptionDataModel, index: number) => {
        setSubmitting(true);
    ...
    const onSubmit_WhenEdit_DispatchAsyncThunk = (data: IProductDescriptionDataModel, index: number) => {
        setSubmitting(true);
    ...
    return (
        <>
            ...
            {viewItemTemplate === ViewItemTemplates.Create &&
                <CreatePartial {...defaultItemCardProps} doneAction={doneAction} item={defaultProductDescription()}
