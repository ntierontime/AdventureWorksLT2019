...
import { getProductDescriptionAvatar, getProductDescriptionTitle, IProductDescriptionDataModel } from 'src/dataModels/IProductDescriptionDataModel';
import { getRouteParamsOfIProductDescriptionIdentifier } from 'src/dataModels/IProductDescriptionQueries';

export default function DetailsPartial(props: ItemCardProps<IProductDescriptionDataModel>): JSX.Element {
    ...
    const title = getProductDescriptionTitle(item);
