...
import { defaultIProductAdvancedQuery, getRouteParamsOfIProductIdentifier, IProductAdvancedQuery, IProductIdentifier } from 'src/dataModels/IProductQueries';
import { productApi } from "src/generated/apiClients/ProductApi";
...
const ProductSlice = createSlice({
    ...
    initialState: entityAdapter.getInitialState({
        ...
        advancedQuery: defaultIProductAdvancedQuery(),
	}),
    reducers: {
        /* any other state updates here */
        setIProductAdvancedQuery: (state, action: PayloadAction<IProductAdvancedQuery>) =>{
...
export const { setIProductAdvancedQuery } = ProductSlice.actions;
