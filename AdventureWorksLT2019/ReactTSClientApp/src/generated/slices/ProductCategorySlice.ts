...
import { defaultIProductCategoryAdvancedQuery, getRouteParamsOfIProductCategoryIdentifier, IProductCategoryAdvancedQuery, IProductCategoryIdentifier } from 'src/dataModels/IProductCategoryQueries';
import { productCategoryApi } from "src/generated/apiClients/ProductCategoryApi";
...
const ProductCategorySlice = createSlice({
    ...
    initialState: entityAdapter.getInitialState({
        ...
        advancedQuery: defaultIProductCategoryAdvancedQuery(),
	}),
    reducers: {
        /* any other state updates here */
        setIProductCategoryAdvancedQuery: (state, action: PayloadAction<IProductCategoryAdvancedQuery>) =>{
...
export const { setIProductCategoryAdvancedQuery } = ProductCategorySlice.actions;
