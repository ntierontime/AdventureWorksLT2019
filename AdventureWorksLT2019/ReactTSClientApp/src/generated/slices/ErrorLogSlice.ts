...
import { defaultIErrorLogAdvancedQuery, getRouteParamsOfIErrorLogIdentifier, IErrorLogAdvancedQuery, IErrorLogIdentifier } from 'src/dataModels/IErrorLogQueries';
import { errorLogApi } from "src/generated/apiClients/ErrorLogApi";
...
const ErrorLogSlice = createSlice({
    ...
    initialState: entityAdapter.getInitialState({
        ...
        advancedQuery: defaultIErrorLogAdvancedQuery(),
	}),
    reducers: {
        /* any other state updates here */
        setIErrorLogAdvancedQuery: (state, action: PayloadAction<IErrorLogAdvancedQuery>) =>{
...
export const { setIErrorLogAdvancedQuery } = ErrorLogSlice.actions;
