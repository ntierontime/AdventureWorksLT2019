...
import { defaultISalesOrderHeaderAdvancedQuery, getRouteParamsOfISalesOrderHeaderIdentifier, ISalesOrderHeaderAdvancedQuery, ISalesOrderHeaderIdentifier } from 'src/dataModels/ISalesOrderHeaderQueries';
import { salesOrderHeaderApi } from "src/generated/apiClients/SalesOrderHeaderApi";
...
const SalesOrderHeaderSlice = createSlice({
    ...
    initialState: entityAdapter.getInitialState({
        ...
        advancedQuery: defaultISalesOrderHeaderAdvancedQuery(),
	}),
    reducers: {
        /* any other state updates here */
        setISalesOrderHeaderAdvancedQuery: (state, action: PayloadAction<ISalesOrderHeaderAdvancedQuery>) =>{
...
export const { setISalesOrderHeaderAdvancedQuery } = SalesOrderHeaderSlice.actions;
