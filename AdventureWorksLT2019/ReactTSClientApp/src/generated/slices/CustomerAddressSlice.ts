...
import { defaultICustomerAddressAdvancedQuery, getRouteParamsOfICustomerAddressIdentifier, ICustomerAddressAdvancedQuery, ICustomerAddressIdentifier } from 'src/dataModels/ICustomerAddressQueries';
import { customerAddressApi } from "src/generated/apiClients/CustomerAddressApi";
...
const CustomerAddressSlice = createSlice({
    ...
    initialState: entityAdapter.getInitialState({
        ...
        advancedQuery: defaultICustomerAddressAdvancedQuery(),
	}),
    reducers: {
        /* any other state updates here */
        setICustomerAddressAdvancedQuery: (state, action: PayloadAction<ICustomerAddressAdvancedQuery>) =>{
...
export const { setICustomerAddressAdvancedQuery } = CustomerAddressSlice.actions;
