...
import { defaultIAddressAdvancedQuery, getRouteParamsOfIAddressIdentifier, IAddressAdvancedQuery, IAddressIdentifier } from 'src/dataModels/IAddressQueries';
import { addressApi } from "src/generated/apiClients/AddressApi";
...
const AddressSlice = createSlice({
    ...
    initialState: entityAdapter.getInitialState({
        ...
        advancedQuery: defaultIAddressAdvancedQuery(),
	}),
    reducers: {
        /* any other state updates here */
        setIAddressAdvancedQuery: (state, action: PayloadAction<IAddressAdvancedQuery>) =>{
...
export const { setIAddressAdvancedQuery } = AddressSlice.actions;
