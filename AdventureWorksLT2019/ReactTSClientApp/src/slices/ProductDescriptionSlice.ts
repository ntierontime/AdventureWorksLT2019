...
export const createComposite = createAsyncThunk(
    'createCompositeProductDescription',
    async (params: IProductDescriptionCompositeModel, { dispatch }) => {
        const response = await productDescriptionApi.CreateComposite(params);
        return response;
    }
)
