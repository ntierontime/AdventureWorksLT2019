...
export interface IBuildVersionIdentifier {
    ...
    systemInformationID: number | string | null; // we can pass enum name to WebApi
    // PredicateType:Equals
    versionDate: string | null; // we can pass enum name to WebApi
    // PredicateType:Equals
    modifiedDate: string | null; // we can pass enum name to WebApi
}
...
export function getRouteParams(item: IBuildVersionIdentifier): string | number {
...
export interface IBuildVersionAdvancedQuery extends IBaseQuery {
    ...
    versionDateRangeLower: string | null;
    versionDateRangeUpper: string | null;
        // PredicateType:Range
...
export const buildVersionQueryOrderBySettings =    
[
