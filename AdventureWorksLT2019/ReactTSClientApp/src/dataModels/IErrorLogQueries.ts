...
export interface IErrorLogIdentifier {
    ...
    errorLogID: number | string | null; // we can pass enum name to WebApi
}
...
export function getRouteParams(item: IErrorLogIdentifier): string | number {
...
export interface IErrorLogAdvancedQuery extends IBaseQuery {
    ...
    errorTimeRangeLower: string | null;
    errorTimeRangeUpper: string | null;
...
export const errorLogQueryOrderBySettings =    
[
