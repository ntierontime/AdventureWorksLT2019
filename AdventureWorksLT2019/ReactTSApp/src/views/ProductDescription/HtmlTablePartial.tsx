...
export default function HtmlTablePartial(props: ListPartialViewProps<IProductDescriptionDataModel, number>): JSX.Element {
    ...
    return (
        <>
                ...
                >
                    ...
                    rows.slice().sort(getComparator(order, orderBy)) */}
                        {orderedListItems
                            ...
                            .map((row, index) => {
                                const isItemSelected = isSelected(row.productDescriptionID);
            ...
            <Popover id="item-action-popover"
                ...
                disableRestoreFocus
            >
                <IconButton aria-label="delete" color="primary" onClick={() => { navigate("/productDescription/delete/" + currentItemOnDialog.productDescriptionID) }}>
                    <DeleteIcon />
                </IconButton>
                <IconButton aria-label="details" color="primary" onClick={() => { navigate("/productDescription/details/" + currentItemOnDialog.productDescriptionID) }}>
                    <BusinessCenterIcon />
                </IconButton>
                <IconButton aria-label="edit" color="primary" onClick={() => { navigate("/productDescription/edit/" + currentItemOnDialog.productDescriptionID) }}>
                    <EditIcon />
                </IconButton>
