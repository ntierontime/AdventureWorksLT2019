...
export default function ItemViewsPartial(props: ItemPartialViewProps<IProductDescriptionDataModel>): JSX.Element {
    ...
    return (
        <>
            {viewItemTemplate === ViewItemTemplates.Create &&
                <CreatePartial {...props}  item = {defaultProductDescription()}/>
            }
