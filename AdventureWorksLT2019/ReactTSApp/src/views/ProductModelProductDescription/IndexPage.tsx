...
export default function IndexPage() {
    ...
    const handleRefresh = () => {
        if (!isLoading) {
            setAdvancedQuery(defaultIProductModelProductDescriptionAdvancedQuery());
            setSelected([]);
            setIsLoading(true);
            dispatch(search(advancedQuery)).finally(() => { setIsLoading(false); });
        }
            ...
            >
                <Box>
                    <Checkbox
                        ...
                        inputProps={{
                            'aria-label': 'select All ProductModelProductDescription',
                        }} />
                    ...
                    <Box sx={{ p: 0, display: 'flex', alignItems: 'center' }}>
                        ...
                        >
                            <OutlinedInput
                                ...
                                placeholder={t("Search") + ' ' + t("ProductModelProductDescription")}
