...
import { createComposite } from 'src/slices/ProductModelProductDescriptionSlice';
...
const wizardSteps = [
    ...
    },
    {
        ...
        description: 'ProductModelProductDescription',
        icon: <Map fontSize='small' />,
        optional: false,
    },
    {
...
export default function CreateWizardPartial(props: WizardPartialProps<IProductModelProductDescriptionCompositeModel>): JSX.Element {
    ...
    const onSubmit = () => {
        ...
        } as IProductModelProductDescriptionCompositeModel;
    ...
    const renderWizardStep = (step: WizardStepProps, index: number, renderWizardButtonGroup: (isFirstStep: boolean, isLastStep: boolean, isStepOptional: boolean, disableNextButton: () => boolean) => JSX.Element,) => {
        return (
            <>
                ...
                {step.id === "__Master__" && <ProductModelProductDescriptionCreatePartial {...getCRUDItemPartialViewPropsWizard<IProductModelProductDescriptionDataModel>(ViewItemTemplates.Create, orientation, (data: IProductModelProductDescriptionDataModel) => { set__Master__(data); })} item={__Master__} isFirstStep={isFirstStep(index)} isLastStep={isLastStep(index)} isStepOptional={step.optional} renderWizardButtonGroup={renderWizardButtonGroup} />}
