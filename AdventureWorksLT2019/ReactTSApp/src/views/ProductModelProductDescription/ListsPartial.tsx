...
import { search } from 'src/slices/ProductModelProductDescriptionSlice';
import { getProductModelProductDescriptionQueryOrderBySettings, IProductModelProductDescriptionAdvancedQuery, IProductModelProductDescriptionIdentifier } from 'src/dataModels/IProductModelProductDescriptionQueries';
            ...
            <Box sx={{ width: '100%' }}>
                <Paper sx={{ width: '100%', mb: 2 }}>
                    ...
                    {listViewOption === ListViewOptions.Table && <HtmlTablePartial
                        ...
                        isSelected={(identifier: IProductModelProductDescriptionIdentifier) => { return false; }}
                    />}
                </Paper>
            </Box>
