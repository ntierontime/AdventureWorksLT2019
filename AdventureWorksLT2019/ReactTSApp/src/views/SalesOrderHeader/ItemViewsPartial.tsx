...
export default function ItemViewsPartial(props: ItemPartialViewProps<ISalesOrderHeaderDataModel>): JSX.Element {
    ...
    return (
        <>
            {viewItemTemplate === ViewItemTemplates.Create &&
                <CreatePartial {...props}  item = {defaultSalesOrderHeader()}/>
            }
