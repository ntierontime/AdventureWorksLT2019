...
import { ISalesOrderDetailIdentifier, getISalesOrderDetailIdentifier, getRouteParamsOfISalesOrderDetailIdentifier } from 'src/dataModels/ISalesOrderDetailQueries';
