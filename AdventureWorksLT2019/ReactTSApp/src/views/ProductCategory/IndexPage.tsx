...
import { defaultIProductCategoryAdvancedQuery, getProductCategoryQueryOrderBySettings, IProductCategoryAdvancedQuery, IProductCategoryIdentifier, getIProductCategoryIdentifier, compareIProductCategoryIdentifier } from 'src/dataModels/IProductCategoryQueries';
...
export default function IndexPage() {
    ...
    const renderEnhancedTopToolbar = () => {
        const props = {
            advancedQuery, defaultAdvancedQuery: defaultIProductCategoryAdvancedQuery(), setAdvancedQuery,
            rowCount,
        ...
        } as ListToolBarProps<IProductCategoryAdvancedQuery, IProductCategoryIdentifier>;
