...
export default function TilesPartial(props: ListPartialViewProps<IProductCategoryDataModel, number>): JSX.Element {
    ...
    // pagination
    const crudItemPartialViewPropsInline = getCRUDItemPartialViewPropsInline<IProductCategoryDataModel>(
    ...
    const [crudItemPartialViewPropsOnDialog, setCRUDItemPartialViewPropsOnDialog] = useState<ItemPartialViewProps<IProductCategoryDataModel> | null>(null);
