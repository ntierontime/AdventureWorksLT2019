...
export default function ItemViewsPartial(props: ItemPartialViewProps<IProductCategoryDataModel>): JSX.Element {
    ...
    return (
        <>
            {viewItemTemplate === ViewItemTemplates.Create &&
                <CreatePartial {...props}  item = {defaultProductCategory()}/>
            }
