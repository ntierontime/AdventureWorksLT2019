...
namespace AdventureWorksLT2019.Services
{
        ...
        : IBuildVersionService
    {
        ...
        public async Task<BuildVersionCompositeModel> GetCompositeModel(BuildVersionIdentifier id, BuildVersionCompositeModel.__DataOptions__[]? dataOptions = null)
        {
            ...
            if (masterResponse.Status != HttpStatusCode.OK || masterResponse.ResponseBody == null)
            {
                ...
                failedResponse.Responses.Add(BuildVersionCompositeModel.__DataOptions__.__Master__, new Response { Status = masterResponse.Status, StatusMessage = masterResponse.StatusMessage });
                return failedResponse;
            }

            var successResponse = new BuildVersionCompositeModel { __Master__ = masterResponse.ResponseBody };
            var responses = new ConcurrentDictionary<BuildVersionCompositeModel.__DataOptions__, Response>();
            responses.TryAdd(BuildVersionCompositeModel.__DataOptions__.__Master__, new Response { Status = HttpStatusCode.OK });
            ...
            successResponse.Responses = new Dictionary<BuildVersionCompositeModel.__DataOptions__, Response>(responses);
