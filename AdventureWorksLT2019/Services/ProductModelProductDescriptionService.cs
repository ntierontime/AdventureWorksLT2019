...
namespace AdventureWorksLT2019.Services
{
        ...
        : IProductModelProductDescriptionService
    {
        ...
        public async Task<ProductModelProductDescriptionCompositeModel> GetCompositeModel(ProductModelProductDescriptionIdentifier id, ProductModelProductDescriptionCompositeModel.__DataOptions__[]? dataOptions = null)
        {
            ...
            if (masterResponse.Status != HttpStatusCode.OK || masterResponse.ResponseBody == null)
            {
                ...
                failedResponse.Responses.Add(ProductModelProductDescriptionCompositeModel.__DataOptions__.__Master__, new Response { Status = masterResponse.Status, StatusMessage = masterResponse.StatusMessage });
                return failedResponse;
            }

            var successResponse = new ProductModelProductDescriptionCompositeModel { __Master__ = masterResponse.ResponseBody };
            var responses = new ConcurrentDictionary<ProductModelProductDescriptionCompositeModel.__DataOptions__, Response>();
            responses.TryAdd(ProductModelProductDescriptionCompositeModel.__DataOptions__.__Master__, new Response { Status = HttpStatusCode.OK });
            ...
            successResponse.Responses = new Dictionary<ProductModelProductDescriptionCompositeModel.__DataOptions__, Response>(responses);
