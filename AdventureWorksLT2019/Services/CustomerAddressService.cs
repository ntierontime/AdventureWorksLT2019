...
namespace AdventureWorksLT2019.Services
{
        ...
        : ICustomerAddressService
    {
        ...
        public async Task<CustomerAddressCompositeModel> GetCompositeModel(CustomerAddressIdentifier id, CustomerAddressCompositeModel.__DataOptions__[]? dataOptions = null)
        {
            ...
            if (masterResponse.Status != HttpStatusCode.OK || masterResponse.ResponseBody == null)
            {
                ...
                failedResponse.Responses.Add(CustomerAddressCompositeModel.__DataOptions__.__Master__, new Response { Status = masterResponse.Status, StatusMessage = masterResponse.StatusMessage });
                return failedResponse;
            }

            var successResponse = new CustomerAddressCompositeModel { __Master__ = masterResponse.ResponseBody };
            var responses = new ConcurrentDictionary<CustomerAddressCompositeModel.__DataOptions__, Response>();
            responses.TryAdd(CustomerAddressCompositeModel.__DataOptions__.__Master__, new Response { Status = HttpStatusCode.OK });
            ...
            successResponse.Responses = new Dictionary<CustomerAddressCompositeModel.__DataOptions__, Response>(responses);
