...
namespace AdventureWorksLT2019.Services
{
        ...
        : ISalesOrderDetailService
    {
        ...
        public async Task<SalesOrderDetailCompositeModel> GetCompositeModel(SalesOrderDetailIdentifier id, SalesOrderDetailCompositeModel.__DataOptions__[]? dataOptions = null)
        {
            ...
            if (masterResponse.Status != HttpStatusCode.OK || masterResponse.ResponseBody == null)
            {
                ...
                failedResponse.Responses.Add(SalesOrderDetailCompositeModel.__DataOptions__.__Master__, new Response { Status = masterResponse.Status, StatusMessage = masterResponse.StatusMessage });
                return failedResponse;
            }

            var successResponse = new SalesOrderDetailCompositeModel { __Master__ = masterResponse.ResponseBody };
            var responses = new ConcurrentDictionary<SalesOrderDetailCompositeModel.__DataOptions__, Response>();
            responses.TryAdd(SalesOrderDetailCompositeModel.__DataOptions__.__Master__, new Response { Status = HttpStatusCode.OK });
            ...
            if (dataOptions == null || dataOptions.Contains(SalesOrderDetailCompositeModel.__DataOptions__.Product))
            {
                tasks.Add(Task.Run(async () =>
                {
                    using (var scope = _serviceScopeFactor.CreateScope())
                    {
                        ...
                        responses.TryAdd(SalesOrderDetailCompositeModel.__DataOptions__.Product, new Response { Status = response.Status, StatusMessage = response.StatusMessage });
            ...
            if (dataOptions == null || dataOptions.Contains(SalesOrderDetailCompositeModel.__DataOptions__.ProductCategory))
            {
                tasks.Add(Task.Run(async () =>
                {
                    using (var scope = _serviceScopeFactor.CreateScope())
                    {
                        ...
                        responses.TryAdd(SalesOrderDetailCompositeModel.__DataOptions__.ProductCategory, new Response { Status = response.Status, StatusMessage = response.StatusMessage });
                        if(response.Status == HttpStatusCode.OK)
                        {
            ...
            if (dataOptions == null || dataOptions.Contains(SalesOrderDetailCompositeModel.__DataOptions__.SalesOrderHeader))
            {
                tasks.Add(Task.Run(async () =>
                {
                    using (var scope = _serviceScopeFactor.CreateScope())
                    {
                        ...
                        responses.TryAdd(SalesOrderDetailCompositeModel.__DataOptions__.SalesOrderHeader, new Response { Status = response.Status, StatusMessage = response.StatusMessage });
                        if(response.Status == HttpStatusCode.OK)
                        {
            ...
            successResponse.Responses = new Dictionary<SalesOrderDetailCompositeModel.__DataOptions__, Response>(responses);
